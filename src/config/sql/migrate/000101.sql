...
INSERT INTO user (type, username, email, name_first, timezone, permissions) VALUES
  ...
  ('staff', 'design', 'design@example.com', 'Designer', 'Australia/Melbourne', 6),
  ('staff', 'staff', 'staff@example.com', 'Staff', 'Australia/Melbourne', 14),
  ('member', 'member', 'user@example.com', 'User', 'Australia/Brisbane', 0)
;
